  ...
  const handleExportPdf = useCallback(async () => {
    ...
    try {
      ...
      const [html2canvasModule, jsPdfModule] = await Promise.all([
        importFromUrl("https://cdn.jsdelivr.net/npm/html2canvas@1.4.1/+esm"),
        importFromUrl("https://cdn.jsdelivr.net/npm/jspdf@2.5.2/+esm"),
      ]);
      ...
      const JsPdf = jsPdfModule.default as new (options: {
